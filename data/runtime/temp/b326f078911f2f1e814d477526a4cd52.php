<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./application/admin/template/users/index.htm";i:1583458996;s:78:"/www/wwwroot/ejucms.wingle.com.cn/application/admin/template/public/layout.htm";i:1580687630;s:78:"/www/wwwroot/ejucms.wingle.com.cn/application/admin/template/public/footer.htm";i:1580687630;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <div class="layui-card">
        <div class="head-oper">
            <div class="fl">
                ...
                <a data-url="<?php echo url('Users/add',['back'=>'index']); ?>" data-type="Users_add" class="layui-btn mt5 ">新增会员</a>
                <?php endif; ?>
            </div>
            <div class="fr">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="layui-table-cell w150 tc right-oper">
                                        ...
                                        <a class="layui-btn btn-edit customvar_edit" data-url="<?php echo url('Users/edit',array('id'=>$vo['id'],'back'=>'index')); ?>" data-type="Users_edit">编辑</a>
