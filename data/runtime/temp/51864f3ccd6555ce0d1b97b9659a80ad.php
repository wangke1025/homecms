<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./template/default/mobile/lists_ershou.htm";i:1574906394;s:68:"/www/wwwroot/ejucms.wingle.com.cn/template/default/mobile/header.htm";i:1573633356;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<section class="af-sx">
    <div class="search-wrap" id="afsearch">
        <div class="search-text"> <i class="icon-search iconfont"></i>
            <input class="text" type="text" name="keyword" value="" placeholder="输入房源名称开始找房">
        </div>
    </div>
    <?php  $tagScreening = new \think\template\taglib\eju\TagScreening; $_result = $tagScreening->getScreening("on", "province_id,city_id,total_price,room,characteristic,diy_junjia", "", "不限","11","","off","2","2","off","off");if(!empty($_result["list"]) || (($_result["list"] instanceof \think\Collection || $_result["list"] instanceof \think\Paginator ) && $_result["list"]->isEmpty())): $field = $_result; ?>
...
<div id="wrapper">
    <div class="af-lp-list">
        <ul class="am-list" id="lists0005" data-total="100">
            ...
            <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
                <a href="<?php echo $field['arcurl']; ?>">
                    ...
                    <div class=" am-u-sm-8 am-list-main newhouse-info ">
                        ...
                        <p class="newhouse-hx"><?php echo $field['room']; ?>室<?php echo $field['living_room']; ?>厅<?php echo $field['toilet']; ?>卫 <?php echo $field['area']; ?>㎡ <?php echo $field['aspect']; ?>  <span class="new"> <?php echo $field['total_price']; ?><?php echo $field['total_price_unit']; ?> </span></p>
                        <p class="newhouse-dz"><?php  $aid = $field['joinaid']; $tag = array (
  'aid' => '$field.joinaid',
  'id' => 'field2',
  'huxing' => 'off',
  'photo' => 'off',
  'price' => 'off',
); if(!isset($aid) || empty($aid)) : $aid = $field['joinaid']; endif; $tagArcview = new \think\template\taglib\eju\TagArcview; $_result = $tagArcview->getArcview($aid, "",$tag); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator):  $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: $field2 = $__LIST__;?><?php echo $field2['title']; endif; else: echo htmlspecialchars_decode("");endif; unset($aid); $field2 = []; ?> -<?php echo $field['address']; ?> </p>
                        <p class="newhouse-jg"> <em></em></p>
                    </div>
                </a>
            </li>
         ...
         <?php  empty($__TAG__) && $__TAG__ = []; $tagArcpagelist = new \think\template\taglib\eju\TagArcpagelist; $_result = $tagArcpagelist->getArcpagelist("lists0005","0","数据加载完成","","", $__TAG__); if(!empty($_result) || (($_result instanceof \think\Collection || $_result instanceof \think\Paginator ) && $_result->isEmpty())): $field = $_result; ?>
