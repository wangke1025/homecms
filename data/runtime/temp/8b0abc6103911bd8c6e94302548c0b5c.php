<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./template/default/mobile/view_xiaoqu.htm";i:1574905880;s:68:"/www/wwwroot/ejucms.wingle.com.cn/template/default/mobile/header.htm";i:1573633356;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <ul>
        <li>
            <span class="intr-title-jg">
                <em><?php echo $eju['field']['average_price']; ?></em><?php echo $eju['field']['price_units']; ?>
        ...
        <li>
            <span class="intr-title-jg">
                二手房源<em><?php  $tagSonarclist = new \think\template\taglib\eju\TagSonarclist; $_result = $tagSonarclist->getSonCount("0", [$eju['field']['aid'],0,12], ['joinaid','is_del','channel'], "archives", ""); echo $_result; unset($_result);?></em>套 出租房源
                <em><?php  $tagSonarclist = new \think\template\taglib\eju\TagSonarclist; $_result = $tagSonarclist->getSonCount("0", [$eju['field']['aid'],0,13], ['joinaid','is_del','channel'], "archives", ""); echo $_result; unset($_result);?></em>套
            </span>
        </li>
...
<div class="lp-detail-info">
    <h3> <a href="#" class="af-head"> <span class="left">小区概况</span>
        <div class="clear"></div>
    </a> </h3>
    <ul class="detail-info-list2 ">
        <li>
            <lable>物业用途:</lable><?php if(is_array($eju['field']['manage_type']) || $eju['field']['manage_type'] instanceof \think\Collection || $eju['field']['manage_type'] instanceof \think\Paginator): $i = 0; $e = 1;$k=0; $__LIST__ = $eju['field']['manage_type'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$vo): $i= intval($key) + 1;$mod = ($i % 2 ); ?><i><?php echo $vo; ?></i><?php ++$e;$k++; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $vo = []; ?>
        </li>
        <li>
            <span>
                <lable>物业费：</lable><?php if(!(empty($eju['field']['property_fee']) || (($eju['field']['property_fee'] instanceof \think\Collection || $eju['field']['property_fee'] instanceof \think\Paginator ) && $eju['field']['property_fee']->isEmpty()))): ?><?php echo $eju['field']['property_fee']; ?><?php echo $eju['field']['property_fee_unit']; else: ?>暂无<?php endif; ?>
            </span>
        </li>
        <li> <span>
						<lable>建筑年代：</lable><?php if(!(empty($eju['field']['building_age']) || (($eju['field']['building_age'] instanceof \think\Collection || $eju['field']['building_age'] instanceof \think\Paginator ) && $eju['field']['building_age']->isEmpty()))): ?><?php echo $eju['field']['building_age']; ?><?php echo $eju['field']['building_age_unit']; else: ?>暂无<?php endif; ?>
					</span><span>
						<lable>停车位：</lable><?php if(!(empty($eju['field']['carport']) || (($eju['field']['carport'] instanceof \think\Collection || $eju['field']['carport'] instanceof \think\Paginator ) && $eju['field']['carport']->isEmpty()))): ?><?php echo $eju['field']['carport']; ?><?php echo $eju['field']['carport_unit']; else: ?>暂无<?php endif; ?>
					</span></li>
        <li> <span>
						<lable>楼层情况：</lable><?php if(!(empty($eju['field']['floor_case']) || (($eju['field']['floor_case'] instanceof \think\Collection || $eju['field']['floor_case'] instanceof \think\Paginator ) && $eju['field']['floor_case']->isEmpty()))): ?><?php echo $eju['field']['floor_case']; ?><?php echo $eju['field']['floor_case_unit']; else: ?>暂无<?php endif; ?>
					</span><span>
						<lable>绿化率：</lable><?php if(!(empty($eju['field']['greening_rate']) || (($eju['field']['greening_rate'] instanceof \think\Collection || $eju['field']['greening_rate'] instanceof \think\Paginator ) && $eju['field']['greening_rate']->isEmpty()))): ?><?php echo $eju['field']['greening_rate']; ?><?php echo $eju['field']['greening_rate_unit']; else: ?>暂无<?php endif; ?>
					</span></li>
        <li> <span>
						<lable>总户数：</lable><?php if(!(empty($eju['field']['households']) || (($eju['field']['households'] instanceof \think\Collection || $eju['field']['households'] instanceof \think\Paginator ) && $eju['field']['households']->isEmpty()))): ?><?php echo $eju['field']['households']; ?><?php echo $eju['field']['households_unit']; else: ?>暂无<?php endif; ?>
					</span><span>
						<lable>建筑类型：</lable><?php if(is_array($eju['field']['building_type']) || $eju['field']['building_type'] instanceof \think\Collection || $eju['field']['building_type'] instanceof \think\Paginator): $i = 0; $e = 1;$k=0; $__LIST__ = $eju['field']['building_type'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$vo): $i= intval($key) + 1;$mod = ($i % 2 ); ?><i><?php echo $vo; ?></i><?php ++$e;$k++; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $vo = []; ?>
					</span></li>
        <li> <span>
						<lable>产权年限：</lable><?php if(!(empty($eju['field']['property']) || (($eju['field']['property'] instanceof \think\Collection || $eju['field']['property'] instanceof \think\Paginator ) && $eju['field']['property']->isEmpty()))): ?><?php echo $eju['field']['property']; ?><?php echo $eju['field']['property_unit']; else: ?>暂无<?php endif; ?>
					</span><span>
						<lable>占地面积：</lable><?php if(!(empty($eju['field']['floor_area']) || (($eju['field']['floor_area'] instanceof \think\Collection || $eju['field']['floor_area'] instanceof \think\Paginator ) && $eju['field']['floor_area']->isEmpty()))): ?><?php echo $eju['field']['floor_area']; ?><?php echo $eju['field']['floor_area_unit']; else: ?>暂无<?php endif; ?>
					</span> </li>
        <li> <span>
						<lable>建筑面积：</lable><?php if(!(empty($eju['field']['building_area']) || (($eju['field']['building_area'] instanceof \think\Collection || $eju['field']['building_area'] instanceof \think\Paginator ) && $eju['field']['building_area']->isEmpty()))): ?><?php echo $eju['field']['building_area']; ?><?php echo $eju['field']['building_area_unit']; else: ?>暂无<?php endif; ?>
					</span><span>
						<lable>容积率：</lable><?php if(!(empty($eju['field']['plot_ratio']) || (($eju['field']['plot_ratio'] instanceof \think\Collection || $eju['field']['plot_ratio'] instanceof \think\Paginator ) && $eju['field']['plot_ratio']->isEmpty()))): ?><?php echo $eju['field']['plot_ratio']; ?><?php echo $eju['field']['plot_ratio_unit']; else: ?>暂无<?php endif; ?>
					</span> </li>
        <li>
            <lable>开发商：</lable><?php if(!(empty($eju['field']['developer']) || (($eju['field']['developer'] instanceof \think\Collection || $eju['field']['developer'] instanceof \think\Paginator ) && $eju['field']['developer']->isEmpty()))): ?><?php echo $eju['field']['developer']; else: ?>暂无<?php endif; ?>
        </li>
        <li>
            <lable>物业公司:</lable><?php if(!(empty($eju['field']['manage_company']) || (($eju['field']['manage_company'] instanceof \think\Collection || $eju['field']['manage_company'] instanceof \think\Paginator ) && $eju['field']['manage_company']->isEmpty()))): ?><?php echo $eju['field']['manage_company']; else: ?>暂无<?php endif; ?>
        </li>
        <li>
            <lable>小区地址:</lable><?php if(!(empty($eju['field']['address']) || (($eju['field']['address'] instanceof \think\Collection || $eju['field']['address'] instanceof \think\Paginator ) && $eju['field']['address']->isEmpty()))): ?><?php echo $eju['field']['address']; else: ?>暂无<?php endif; ?>
        </li>
        <li>
            <lable>特色标签:</lable><?php if(is_array($eju['field']['characteristic']) || $eju['field']['characteristic'] instanceof \think\Collection || $eju['field']['characteristic'] instanceof \think\Paginator): $i = 0; $e = 1;$k=0; $__LIST__ = $eju['field']['characteristic'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$vo): $i= intval($key) + 1;$mod = ($i % 2 ); ?><i style=""><?php echo $vo; ?></i><?php ++$e;$k++; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $vo = []; ?>
        </li>

    </ul>
</div>
<div class="lp-detail-info">
    <h3> <a href="#" class="af-head"> <span class="left">小区介绍</span>
        <div class="clear"></div>
    </a> </h3>
...
<div class="tjlp_list">
    <h3> <a href="#" class="af-head"> <span class="left">二手房</span>
        <div class="clear"></div>
    </a> </h3>
    <ul class="clearfloat">
        <?php  $typeid = "11"; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $row = 4; $channelid = ""; $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> $channelid,      "joinaid"=> $eju['field']['aid'],      "province_id"=> "",      "city_id"=> "",      "area_id"=> "",      "screen"=> "1",      "users_id"=> "", ); $tag = array (
  'typeid' => '11',
...
<div class="tjlp_list">
    <h3> <a href="#" class="af-head"> <span class="left">出租房</span>
        <div class="clear"></div>
    </a> </h3>
    <ul class="clearfloat">
        <?php  $typeid = "12"; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $row = 4; $channelid = ""; $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> $channelid,      "joinaid"=> $eju['field']['aid'],      "province_id"=> "",      "city_id"=> "",      "area_id"=> "",      "screen"=> "1",      "users_id"=> "", ); $tag = array (
  'typeid' => '12',
  'joinaid' => '$eju.field.aid',
  'orderby' => 'new',
  'limit' => '0,4',
        ...
        <li>
            <a href="<?php echo $field['arcurl']; ?>">
                ...
                <div class="tjlp_list_cont">
                    <p class="tjlp_list_head"><?php echo $field['title']; ?></p>
                    <p class="tjlp_list_area"><?php echo $field['room']; ?>室<?php echo $field['living_room']; ?>厅<?php echo $field['toilet']; ?>卫</p>
                    <p class="tjlp_list_area"><?php echo get_province_name($field['province_id']); ?>-<?php echo get_city_name($field['city_id']); ?></p>
                    <p class="tjlp_list_jg"><em><?php echo $field['total_price']; ?></em><?php echo $field['price_units']; ?></p>
...
<li class="list_gg lp-detail-dt">
    <a href="tel:<?php echo $eju['field']['sale_phone']; ?>,<?php echo $eju['field']['phone_code']; ?>">
...
<div class="tjlp_list">
    <h3> <a href="javascript:;" class="af-head"> <span class="left">推荐房源</span>
        <div class="clear"></div>
    </a> </h3>
    <ul class="clearfloat">
  ...
  'id' => 'field',
        ...
        <li>
            <a href="<?php echo $field['arcurl']; ?>">
                ...
                <div class="tjlp_list_cont">
                    <p class="tjlp_list_head"><?php echo $field['title']; ?></p>
                    <p class="tjlp_list_area"><?php echo $field['room']; ?>室<?php echo $field['living_room']; ?>厅</p>
                    <p class="tjlp_list_jg"><em><?php echo $field['total_price']; ?>万</em></p>
                    <p class="tjlp_list_area">
                        <?php if(is_array($field['characteristic']) || $field['characteristic'] instanceof \think\Collection || $field['characteristic'] instanceof \think\Paginator): $i = 0; $e = 1;$k=0; $__LIST__ = $field['characteristic'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$vo): $i= intval($key) + 1;$mod = ($i % 2 ); ?>
                        <span class="tjlp_list_tag intr-title-ts"><?php echo $vo; ?></span>
...
<div data-am-widget="navbar" class="am-navbar am-cf am-navbar-default " id="">
    <ul class="am-navbar-nav am-cf am-avg-sm-4">
        <li>
            <a class="tg_tel_phone" href="tel:<?php echo $eju['field']['sale_phone']; ?>,<?php echo $eju['field']['phone_code']; ?>">电话咨询</a>
        </li>
