<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./template/default/mobile/lists_xiaoqu.htm";i:1571983346;s:68:"/www/wwwroot/ejucms.wingle.com.cn/template/default/mobile/header.htm";i:1573633356;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
  ...
  'id' => 'field',
            ...
            <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
                <a href="<?php echo $field['arcurl']; ?>">
                    ...
                    <div class=" am-u-sm-8 am-list-main newhouse-info ">
                        ...
                        <p class="newhouse-hx"><?php echo $field['building_age']; ?>年建成</p>
                        ...
                        <p class="newhouse-jg">
                            <em>在售</em> <?php  $tagSonarclist = new \think\template\taglib\eju\TagSonarclist; $_result = $tagSonarclist->getSonCount("0", [$field['aid'],0,12], ['joinaid','is_del','channel'], "archives", ""); echo $_result; unset($_result);?> <em>套  在租</em>
                            <?php  $tagSonarclist = new \think\template\taglib\eju\TagSonarclist; $_result = $tagSonarclist->getSonCount("0", [$field['aid'],0,13], ['joinaid','is_del','channel'], "archives", ""); echo $_result; unset($_result);?><em>套</em>
                        </p>
                    </div>
                </a>
            </li>
         ...
         <?php  empty($__TAG__) && $__TAG__ = []; $tagArcpagelist = new \think\template\taglib\eju\TagArcpagelist; $_result = $tagArcpagelist->getArcpagelist("lists0004","0","数据加载完成","","", $__TAG__); if(!empty($_result) || (($_result instanceof \think\Collection || $_result instanceof \think\Paginator ) && $_result->isEmpty())): $field = $_result; ?>
