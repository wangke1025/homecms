<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./template/default/mobile/lists_zufang.htm";i:1572831748;s:68:"/www/wwwroot/ejucms.wingle.com.cn/template/default/mobile/header.htm";i:1573633356;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
    <div class="af-lp-list">
        <ul class="am-list" id="lists0006" data-total="100">
            ...
            <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
                <a href="<?php echo $field['arcurl']; ?>">
                    ...
                    <div class=" am-u-sm-8 am-list-main newhouse-info ">
                        ...
                        <p class="newhouse-hx"><?php echo $field['room']; ?>室<?php echo $field['living_room']; ?>厅<?php echo $field['toilet']; ?>卫 <?php echo $field['area']; ?>㎡ <?php echo $field['aspect']; ?>  <span class="new"> <?php echo $field['total_price']; ?> <em><?php echo $field['price_units']; ?></em> </span></p>
  ...
  'price' => 'off',
         ...
         <?php  empty($__TAG__) && $__TAG__ = []; $tagArcpagelist = new \think\template\taglib\eju\TagArcpagelist; $_result = $tagArcpagelist->getArcpagelist("lists0006","0","数据加载完成","","", $__TAG__); if(!empty($_result) || (($_result instanceof \think\Collection || $_result instanceof \think\Paginator ) && $_result->isEmpty())): $field = $_result; ?>
